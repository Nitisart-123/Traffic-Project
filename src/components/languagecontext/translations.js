...
export const translations = {
  th: {
    ...
    editUserAccount: {
      ...
      labelRank: "ตำแหน่ง",
      labelName: "ชื่อ",
      labelOldPassword: "รหัสผ่านเดิม",
      labelNewPassword: "รหัสผ่านใหม่",
      labelConfirmPassword: "ยืนยันรหัสผ่านใหม่",
      placeholderOldPassword: "กรอกรหัสผ่านเดิม (ถ้าต้องการเปลี่ยน)",
      placeholderNewPassword: "เว้นว่างหากไม่ต้องการเปลี่ยน",
      placeholderConfirmPassword: "กรอกรหัสผ่านใหม่อีกครั้ง",
      passwordHint: "หากต้องการเปลี่ยนรหัสผ่าน กรุณากรอกรหัสผ่านเดิมก่อน",
      saveButton: "บันทึก",
      saving: "กำลังบันทึก...",
      cancelButton: "ยกเลิก",
      errorRequired: "กรุณากรอกข้อมูลให้ครบ",
      errorOldPasswordRequired: "กรุณากรอกรหัสผ่านเดิมก่อนเปลี่ยนรหัสผ่าน",
      errorOldPasswordIncorrect: "รหัสผ่านเดิมไม่ถูกต้อง",
      errorPasswordMismatch: "รหัสผ่านใหม่และการยืนยันไม่ตรงกัน",
      errorUpdateFailed: "เกิดข้อผิดพลาดในการแก้ไขข้อมูล",
    },
  },
  en: {
    ...
    editUserAccount: {
      ...
      placeholderOldPassword: "Enter current password (if changing)",
      placeholderNewPassword: "Leave blank to keep current password",
      placeholderConfirmPassword: "Re-enter new password",
      passwordHint: "To change your password, please enter your current password first",
      saveButton: "Save",
      saving: "Saving...",
      cancelButton: "Cancel",
      errorRequired: "Please fill in all the fields",
      errorOldPasswordRequired: "Please enter your current password to change it",
      errorOldPasswordIncorrect: "Current password is incorrect",
